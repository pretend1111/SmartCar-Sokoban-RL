"""Final round 2: best teacher candidates on 90 maps."""
...
cfgs = [
    ...
    ('v10 α=0.4', functools.partial(planner_oracle_v10, alpha=0.4)),
    ('v12 α=0.4', functools.partial(planner_oracle_v12, alpha=0.4)),
    ('v12 α=0.7', functools.partial(planner_oracle_v12, alpha=0.7)),
    ('v12 α=1.0', functools.partial(planner_oracle_v12, alpha=1.0)),
]
for label, pl in cfgs:
    ...
    print(f'  {label:<18}: wins {wins:>3}/{len(trials)}  avg={avg:.2f}  gambling={tg}/{tf}={rate:.1f}%', flush=True)
