...
cfgs = [
    ...
    ('v18 λ=2', functools.partial(planner_oracle_v18, gambling_weight=2.0)),
    ('v18 λ=5', functools.partial(planner_oracle_v18, gambling_weight=5.0)),
    ('v18 λ=10', functools.partial(planner_oracle_v18, gambling_weight=10.0)),
]
